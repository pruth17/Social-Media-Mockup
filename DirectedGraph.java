...
public class DirectedGraph<T> implements GraphInterface<T> {
	...
	public double getCheapestPath(T begin, T end, StackInterface<T> path) {
		...
		// the same vertex but different costs - cost of path to vertex is
		// EntryPQ's priority value
		...
		while (!done && !priorityQueue.isEmpty()) {
			...
			if (!frontVertex.isVisited()) {
				...
				if (frontVertex.equals(endVertex))
					...
					Iterator<VertexInterface<T>> neighbors = frontVertex
							.getNeighborIterator();
					Iterator<Double> edgeWeights = frontVertex
							.getWeightIterator();
					while (neighbors.hasNext()) {
						...
						if (!nextNeighbor.isVisited()) {
							double nextCost = weightOfEdgeToNeighbor
									+ frontVertex.getCost();
							priorityQueue.add(new EntryPQ(nextNeighbor,
	...
	public void displayEdges() {
		...
		System.out
				.println("(Edge weights are given; weights are zero for unweighted graphs):\n");
		Iterator<VertexInterface<T>> vertexIterator = vertices
				.getValueIterator();
		while (vertexIterator.hasNext()) {
	...
	public boolean addVertex(T vertexLabel) {
		VertexInterface<T> addOutcome = vertices.add(vertexLabel, new Vertex<>(
				vertexLabel));
